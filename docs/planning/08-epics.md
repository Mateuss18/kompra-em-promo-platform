...
Identificar loja, coletar dados e normalizar links de afiliado.

## EPIC-10 — Geração de imagem

Criar a imagem inicial com foto do produto e slogan do grupo.
...
Criar templates visuais avançados usando Konva.js no frontend e Sharp no backend.
